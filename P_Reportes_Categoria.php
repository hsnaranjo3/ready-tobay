...
$resultado="SELECT * FROM productos INNER JOIN categorias ON productos.categoria_id = categorias.id WHERE categoria = '$Cat'";
...
while ($registroCarreras = $res->fetch_array(MYSQLI_BOTH)){	  
 ...
 echo '
          <tr>
			...
			<td class="table-active">'.$registroCarreras['categoria'].'</td>
