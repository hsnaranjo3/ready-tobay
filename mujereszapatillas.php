...
<Table width="75%">
	<tr>
		<td width="20%"> 
			<font size="+4" face="cambria" color="black">
				<img SRC="Images/zapatillasm1.jpg" WIDTH=250 HEIGHT=200> 
			</font>
		</td>
		<td width="20%">
			<font size="+4" face="cambria"  color="black">
				<img SRC="Images/zapatillasm2.jpg" WIDTH=250 HEIGHT=200>  
			</font>
		</td>
		<td width="20%">
			<font size="+4"  face="cambria" color="black">
				<img SRC="Images/zapatillasm3.jpg" WIDTH=250 HEIGHT=200> 
			</font>
		</td>
		<td width="20%">
			<font size="+4"  face="cambria" color="black">
				<img SRC="Images/zapatillasm4.jpg" WIDTH=250 HEIGHT=200 > 
			</font>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20%"> 
			<font size="+4" face="cambria" color="black">
				<IMG SRC="Images/zapatillasm5.jpg" WIDTH=250 HEIGHT=200>
			</font>
		</td>
		<td width="20%"> 
			<font size="+4" face="cambria"  color="black">
				<IMG SRC="Images/zapatillasm6.jpg" WIDTH=250 HEIGHT=200> 
			</font>
		</td>
		<td width="20%">
			<font size="+4"  face="cambria" color="black">
				<IMG SRC="Images/zapatillasm7.jpg" WIDTH=250 HEIGHT=200>
			</font>
		</td>
		<td width="20%">
			<font size="+4"  face="cambria" color="black">
				<IMG SRC="Images/zapatillasm8.jpg" WIDTH=250 HEIGHT=200 >
			</font>
		</td>
	</tr>
	<tr>
